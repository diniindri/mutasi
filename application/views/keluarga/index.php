<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row mb-3">
        <div class="col-lg-7">
            ...
            <a href="<?= base_url('keluarga/tarik-keluarga-hris/') . $nip . '/' . $pegawai_id . '/' . $sk_id; ?>" class="btn btn-sm btn-outline-secondary mt-1 mb-1 ml-2" onclick="return confirm('Apakah Anda yakin akan melakukan tarik data keluarga?');"> Tarik Data Keluarga HRIS</a>
        </div>
        <div class="col-lg-5">
