    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" name="tanggal" id="myFlat" class="form-control <?= form_error('tanggal') ? 'is-invalid' : ''; ?>" placeholder="dd-mm-yyyy" value="<?= date('d-m-Y', $sk['tanggal']); ?>">
                <div class="invalid-feedback">
                    <?= form_error('tanggal'); ?>
                </div>
            </div>
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" name="tglspp" id="myFlat" class="form-control <?= form_error('tglspp') ? 'is-invalid' : ''; ?>" placeholder="dd-mm-yyyy" value="<?= date('d-m-Y', $sk['tglspp']); ?>">
                <div class="invalid-feedback">
                    <?= form_error('tglspp'); ?>
                </div>
            </div>
