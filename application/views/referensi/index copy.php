<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <a href="<?= base_url('tarif_darat/index'); ?>" class="btn btn-outline-secondary mt-1 mb-1"> Tarif Darat</a>
        </div>
        <div class="col-lg-3">
            <a href="<?= base_url('dokumen/index'); ?>" class="btn btn-outline-secondary mt-1 mb-1"> Dokumen</a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-3">
            <a href="<?= base_url('pejabat/index'); ?>" class="btn btn-outline-secondary mt-1 mb-1"> Pejabat</a>
        </div>
    </div>
</main>